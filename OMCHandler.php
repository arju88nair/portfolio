...
// Data mapper class for creating data objects for the Sales order/Accounts creation
    ...
    function dataMapper()
    {
        ...
        $servicesObj->elem = "0";
        $servicesObj->login = $account['account_no'];
        $servicesObj->passwd_CLEAR = "Cvly@12$";
        $servicesObj->service_OBJ = "0.0.0.1 /service/cloud/ip -1 0";
        ...
        $productDeal->products = array($productDealObj);
...
//        $dealsProduct->products=$productDealObj;
        ...
        $inputFlist->end_T = str_replace('+00:00', 'Z', gmdate('c'));
        $inputFlist->flags = "0";
